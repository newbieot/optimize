(() => {
  ...
  function enhanceHeader(){
    ...
    h.innerHTML=`<div class="app-brand-lockup"><div class="app-brand-mark" aria-hidden="true">O</div><div class="app-brand-copy"><small>PosNew Hub</small><h1>Optimalisasi Proyek Logistik</h1></div><span class="app-version text-[10px] md:text-xs font-bold px-2.5 py-1 rounded-full">v5.0</span></div><div class="header-actions"><span class="header-privacy">🔒 Data diproses di browser</span><button onclick="logoutFirebase()" class="bg-red-50 text-red-600 border border-red-200 px-3 py-2 rounded-lg font-bold text-sm">Keluar</button></div>`;
  }
  function enhanceFooter(){ const f=$('#appFooter'); if(!f)return; f.innerHTML=`<div class="footer-brand"><a href="https://posnew.com" target="_blank" rel="noopener">PosNew Hub</a></div><p class="footer-desc">Business tools for smarter logistics decisions.</p><div class="footer-creator-badge">Data proyek tetap tersimpan di perangkat Anda</div>`; }
